...
/***/ function(module, exports, __webpack_require__) {
	...
	var Router = _vue2.default.extend(_router2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK VAR INJECTION */(function(module, jquery) {"use strict";
	...
	(function () {
	  var block = { newline: /^\n+/, code: /^( {4}[^\n]+\n*)+/, fences: noop, hr: /^( *[-*_]){3,} *(?:\n+|$)/, heading: /^ *(#{1,6}) *([^\n]+?) *#* *(?:\n+|$)/, nptable: noop, lheading: /^([^\n]+)\n *(=|-){2,} *(?:\n+|$)/, blockquote: /^( *>[^\n]+(\n(?!def)[^\n]+)*\n*)+/, list: /^( *)(bull) [\s\S]+?(?:hr|def|\n{2,}(?! )(?!\1bull )\n*|\s*$)/, html: /^ *(?:comment *(?:\n|\s*$)|closed *(?:\n{2,}|\s*$)|closing *(?:\n{2,}|\s*$))/, def: /^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +["(]([^\n]+)[")])? *(?:\n+|$)/, table: noop, paragraph: /^((?:[^\n]+\n?(?!hr|heading|lheading|blockquote|tag|def))+)\n*/, text: /^[^\n]+/ };block.bullet = /(?:[*+-]|\d+\.)/;block.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/;block.item = replace(block.item, "gm")(/bull/g, block.bullet)();block.list = replace(block.list)(/bull/g, block.bullet)("hr", "\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))")("def", "\\n+(?=" + block.def.source + ")")();block.blockquote = replace(block.blockquote)("def", block.def)();block._tag = "(?!(?:" + "a|em|strong|small|s|cite|q|dfn|abbr|data|time|code" + "|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo" + "|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|[^\\w\\s@]*@)\\b";block.html = replace(block.html)("comment", /<!--[\s\S]*?-->/)("closed", /<(tag)[\s\S]+?<\/\1>/)("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g, block._tag)();block.paragraph = replace(block.paragraph)("hr", block.hr)("heading", block.heading)("lheading", block.lheading)("blockquote", block.blockquote)("tag", "<" + block._tag)("def", block.def)();block.normal = merge({}, block);block.gfm = merge({}, block.normal, { fences: /^ *(`{3,}|~{3,}) *(\S+)? *\n([\s\S]+?)\s*\1 *(?:\n+|$)/, paragraph: /^/ });block.gfm.paragraph = replace(block.paragraph)("(?!", "(?!" + block.gfm.fences.source.replace("\\1", "\\2") + "|" + block.list.source.replace("\\1", "\\3") + "|")();block.tables = merge({}, block.gfm, { nptable: /^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/, table: /^ *\|(.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/ });function Lexer(options) {
	    ...
	    var src = src.replace(/^ +$/gm, ""),
	      ...
	      if (cap = this.rules.newline.exec(src)) {
	        ...
	        src = src.substring(cap[0].length);bull = cap[2];this.tokens.push({ type: "list_start", ordered: bull.length > 1 });cap = cap[0].match(this.rules.item);next = false;l = cap.length;i = 0;for (; i < l; i++) {
	          ...
	          }this.tokens.push({ type: loose ? "loose_item_start" : "list_item_start" });this.token(item, false, bq);
	    ...
	    var out = "",
	        ...
	        i = 0,
	        ch;for (; i < l; i++) {
	      ch = text.charCodeAt(i);if (Math.random() > 0.5) {
	        ch = "x" + ch.toString(16);
	      }out += "&#" + ch + ";";
	    }return out;
	    ...
	    switch (this.token.type) {case "space":
	        ...
	        var body = "",
	          ...
	          body += this.tok();
	        }return this.renderer.list(body, ordered);case "list_item_start":
	        ...
	        var html = !this.token.pre && !this.options.pedantic ? this.inline.output(this.token.text) : this.token.text;return this.renderer.html(html);case "paragraph":
	    ...
	    regex = regex.source;opt = opt || "";return function self(name, val) {
	      ...
	      }val = val.source || val;val = val.replace(/(^|[^\[])\^/g, "$1");regex = regex.replace(name, val);return self;
	    };
	    ...
	    if (callback || typeof opt === "function") {
	      if (!callback) {
	        ...
	        return done();
	      }delete opt.highlight;if (!pending) {
	        return done();
	  ...
	  };marked.defaults = { gfm: true, tables: true, breaks: false, pedantic: false, sanitize: false, smartLists: false, silent: false, highlight: null, langPrefix: "lang-", smartypants: false, headerPrefix: "", renderer: new Renderer(), xhtml: false };marked.Parser = Parser;marked.parser = Parser.parse;marked.Renderer = Renderer;marked.Lexer = Lexer;marked.lexer = Lexer.lex;marked.InlineLexer = InlineLexer;marked.inlineLexer = InlineLexer.output;marked.parse = marked;if (typeof module !== "undefined" && ( false ? "undefined" : (0, _typeof3.default)(exports)) === "object") {
	...
	var IN_GLOBAL_SCOPE = true;window["PR_SHOULD_USE_CONTINUATION"] = true;var prettyPrintOne;var prettyPrint;(function () {
	  var P = window;var i = ["break,continue,do,else,for,if,return,while"];var u = [i, "auto,case,char,const,default," + "double,enum,extern,float,goto,inline,int,long,register,short,signed," + "sizeof,static,struct,switch,typedef,union,unsigned,void,volatile"];var p = [u, "catch,class,delete,false,import," + "new,operator,private,protected,public,this,throw,true,try,typeof"];var l = [p, "alignof,align_union,asm,axiom,bool," + "concept,concept_map,const_cast,constexpr,decltype,delegate," + "dynamic_cast,explicit,export,friend,generic,late_check," + "mutable,namespace,nullptr,property,reinterpret_cast,static_assert," + "static_cast,template,typeid,typename,using,virtual,where"];var y = [p, "abstract,assert,boolean,byte,extends,final,finally,implements,import," + "instanceof,interface,null,native,package,strictfp,super,synchronized," + "throws,transient"];var U = [y, "as,base,by,checked,decimal,delegate,descending,dynamic,event," + "fixed,foreach,from,group,implicit,in,internal,into,is,let," + "lock,object,out,override,orderby,params,partial,readonly,ref,sbyte," + "sealed,stackalloc,string,select,uint,ulong,unchecked,unsafe,ushort," + "var,virtual,where"];var r = "all,and,by,catch,class,else,extends,false,finally," + "for,if,in,is,isnt,loop,new,no,not,null,of,off,on,or,return,super,then," + "throw,true,try,unless,until,when,while,yes";var x = [p, "debugger,eval,export,function,get,null,set,undefined,var,with," + "Infinity,NaN"];var s = "caller,delete,die,do,dump,elsif,eval,exit,foreach,for," + "goto,if,import,last,local,my,next,no,our,print,package,redo,require," + "sub,undef,unless,until,use,wantarray,while,BEGIN,END";var K = [i, "and,as,assert,class,def,del," + "elif,except,exec,finally,from,global,import,in,is,lambda," + "nonlocal,not,or,pass,print,raise,try,with,yield," + "False,True,None"];var g = [i, "alias,and,begin,case,class," + "def,defined,elsif,end,ensure,false,in,module,next,nil,not,or,redo," + "rescue,retry,self,super,then,true,undef,unless,until,when,yield," + "BEGIN,END"];var z = [i, "as,assert,const,copy,drop," + "enum,extern,fail,false,fn,impl,let,log,loop,match,mod,move,mut,priv," + "pub,pure,ref,self,static,struct,true,trait,type,unsafe,use"];var J = [i, "case,done,elif,esac,eval,fi," + "function,in,local,set,then,until"];var C = [l, U, x, s, K, g, J];var e = /^(DIR|FILE|vector|(de|priority_)?queue|list|stack|(const_)?iterator|(multi)?(set|map)|bitset|u?(int|float)\d*)\b/;var E = "str";var B = "kwd";var j = "com";var R = "typ";var I = "lit";var N = "pun";var H = "pln";var m = "tag";var G = "dec";var L = "src";var S = "atn";var n = "atv";var Q = "nocode";var O = "(?:^^\\.?|[+-]|[!=]=?=?|\\#|%=?|&&?=?|\\(|\\*=?|[+\\-]=|->|\\/=?|::?|<<?=?|>>?>?=?|,|;|\\?|@|\\[|~|{|\\^\\^?=?|\\|\\|?=?|break|case|continue|delete|do|else|finally|instanceof|return|throw|try|typeof)\\s*";function k(ac) {
	    var ag = 0;var V = false;var af = false;for (var Y = 0, X = ac.length; Y < X; ++Y) {
	      ...
	      }var aj = String.fromCharCode(ai);return aj === "\\" || aj === "-" || aj === "]" || aj === "^" ? "\\" + aj : aj;
	    }function aa(ao) {
	      var at = ao.substring(1, ao.length - 1).match(new RegExp("\\\\u[0-9A-Fa-f]{4}" + "|\\\\x[0-9A-Fa-f]{2}" + "|\\\\[0-3][0-7]{0,2}" + "|\\\\[0-7]{1,2}" + "|\\\\[\\s\\S]" + "|-" + "|[^-\\\\]", "g"));var ai = [];var aq = at[0] === "^";var ap = ["["];if (aq) {
	        ap.push("^");
	      }for (var au = aq ? 1 : 0, am = at.length; au < am; ++au) {
	        var ak = at[au];if (/\\[bdsw]/i.test(ak)) {
	          ap.push(ak);
	        } else {
	          var aj = ae(ak);var an;if (au + 2 < am && "-" === at[au + 1]) {
	            an = ae(at[au + 2]);au += 2;
	          } else {
	            an = aj;
	          }ai.push([aj, an]);if (!(an < 65 || aj > 122)) {
	            if (!(an < 65 || aj > 90)) {
	      ...
	      });var al = [];var ar = [];for (var au = 0; au < ai.length; ++au) {
	        var av = ai[au];if (av[0] <= ar[1] + 1) {
	          ar[1] = Math.max(ar[1], av[1]);
	        } else {
	          al.push(ar = av);
	        }
	      }for (var au = 0; au < al.length; ++au) {
	        var av = al[au];ap.push(W(av[0]));if (av[1] > av[0]) {
	          if (av[1] + 1 > av[0]) {
	            ap.push("-");
	          }ap.push(W(av[1]));
	        }
	      }ap.push("]");return ap.join("");
	    }function Z(ao) {
	      var am = ao.source.match(new RegExp("(?:" + "\\[(?:[^\\x5C\\x5D]|\\\\[\\s\\S])*\\]" + "|\\\\u[A-Fa-f0-9]{4}" + "|\\\\x[A-Fa-f0-9]{2}" + "|\\\\[0-9]+" + "|\\\\[^ux0-9]" + "|\\(\\?[:!=]" + "|[\\(\\)\\^]" + "|[^\\x5B\\x5C\\(\\)\\^]+" + ")", "g"));var ak = am.length;var aq = [];for (var an = 0, ap = 0; an < ak; ++an) {
	        var aj = am[an];if (aj === "(") {
	          ++ap;
	        } else {
	          if ("\\" === aj.charAt(0)) {
	            var ai = +aj.substring(1);if (ai) {
	              if (ai <= ap) {
	                aq[ai] = -1;
	              } else {
	                am[an] = W(ai);
	        ...
	        var aj = am[an];if (aj === "(") {
	          ...
	          if ("\\" === aj.charAt(0)) {
	            var ai = +aj.substring(1);if (ai && ai <= ap) {
	              am[an] = "\\" + aq[ai];
	            }
	          }
	        }
	        ...
	        for (var an = 0; an < ak; ++an) {
	          var aj = am[an];var al = aj.charAt(0);if (aj.length >= 2 && al === "[") {
	            am[an] = aa(aj);
	          } else {
	            if (al !== "\\") {
	              am[an] = aj.replace(/[a-zA-Z]/g, function (ar) {
	                var at = ar.charCodeAt(0);return "[" + String.fromCharCode(at & ~32, at | 32) + "]";
	              });
	            }
	          }
	        }
	      }return am.join("");
	    }var ad = [];for (var Y = 0, X = ac.length; Y < X; ++Y) {
	      var ah = ac[Y];if (ah.global || ah.multiline) {
	        throw new Error("" + ah);
	      }ad.push("(?:" + Z(ah) + ")");
	    }return new RegExp(ad.join("|"), af ? "gi" : "g");
	  }function b(ab, Z) {
	    var X = /(?:^|\s)nocode(?:\s|$)/;var ac = [];var aa = 0;var Y = [];var W = 0;function V(ae) {
	      var ad = ae.nodeType;if (ad == 1) {
	        if (X.test(ae.className)) {
	          return;
	        }for (var ah = ae.firstChild; ah; ah = ah.nextSibling) {
	          V(ah);
	        }var ag = ae.nodeName.toLowerCase();if ("br" === ag || "li" === ag) {
	          ac[W] = "\n";Y[W << 1] = aa++;Y[W++ << 1 | 1] = ae;
	        }
	      } else {
	        if (ad == 3 || ad == 4) {
	          var af = ae.nodeValue;if (af.length) {
	            if (!Z) {
	              af = af.replace(/[ \t\r\n]+/g, " ");
	            } else {
	              af = af.replace(/\r\n?/g, "\n");
	            }ac[W] = af;Y[W << 1] = aa;aa += af.length;Y[W++ << 1 | 1] = ae;
	          }
	        }
	      }
	    }V(ab);return { sourceCode: ac.join("").replace(/\n$/, ""), spans: Y };
	  }function D(V, X, Z, W) {
	    if (!X) {
	      return;
	    }var Y = { sourceCode: X, basePos: V };Z(Y);W.push.apply(W, Y.decorations);
	  }var v = /\S/;function o(V) {
	    var Y = undefined;for (var X = V.firstChild; X; X = X.nextSibling) {
	      var W = X.nodeType;Y = W === 1 ? Y ? V : X : W === 3 ? v.test(X.nodeValue) ? V : Y : Y;
	    }return Y === V ? undefined : Y;
	  }function f(X, W) {
	    var V = {};var Y;(function () {
	      var ag = X.concat(W);var ak = [];var aj = {};for (var ae = 0, ac = ag.length; ae < ac; ++ae) {
	        var ab = ag[ae];var af = ab[3];if (af) {
	          for (var ah = af.length; --ah >= 0;) {
	            V[af.charAt(ah)] = ab;
	          }
	        }var ai = ab[1];var ad = "" + ai;if (!aj.hasOwnProperty(ad)) {
	          ak.push(ai);aj[ad] = null;
	        }
	      }ak.push(/[\0-\uffff]/);Y = k(ak);
	    })();var aa = W.length;var Z = function Z(ak) {
	      var ac = ak.sourceCode,
	          ab = ak.basePos;var ag = [ab, H];var ai = 0;var aq = ac.match(Y) || [];var am = {};for (var ah = 0, au = aq.length; ah < au; ++ah) {
	        var aj = aq[ah];var at = am[aj];var al = void 0;var ap;if (typeof at === "string") {
	          ap = false;
	        } else {
	          var ad = V[aj.charAt(0)];if (ad) {
	            al = aj.match(ad[1]);at = ad[0];
	          } else {
	            for (var ar = 0; ar < aa; ++ar) {
	              ad = W[ar];al = aj.match(ad[1]);if (al) {
	                at = ad[0];break;
	              }
	            }if (!al) {
	              at = H;
	            }
	          }ap = at.length >= 5 && "lang-" === at.substring(0, 5);if (ap && !(al && typeof al[1] === "string")) {
	            ap = false;at = L;
	          }if (!ap) {
	            am[aj] = at;
	          }
	        }var ae = ai;ai += aj.length;if (!ap) {
	          ag.push(ab + ae, at);
	        } else {
	          var ao = al[1];var an = aj.indexOf(ao);var af = an + ao.length;if (al[2]) {
	            af = aj.length - al[2].length;an = af - ao.length;
	          }var av = at.substring(5);D(ab + ae, aj.substring(0, an), Z, ag);D(ab + ae + an, ao, q(av, ao), ag);D(ab + ae + af, aj.substring(af), Z, ag);
	        }
	      }ak.decorations = ag;
	    };return Z;
	  }function h(af) {
	    var X = [],
	        ab = [];if (af["tripleQuotedStrings"]) {
	      ...
	      ab.push([j, /^\/\/[^\r\n]*/, null]);ab.push([j, /^\/\*[\s\S]*?(?:\*\/|$)/, null]);
	    }var W = af["regexLiterals"];if (W) {
	      var Y = W > 1 ? "" : "\n\r";var aa = Y ? "." : "[\\S\\s]";var Z = "/(?=[^/*" + Y + "])" + "(?:[^/\\x5B\\x5C" + Y + "]" + "|\\x5C" + aa + "|\\x5B(?:[^\\x5C\\x5D" + Y + "]" + "|\\x5C" + aa + ")*(?:\\x5D|$))+" + "/";ab.push(["lang-regex", RegExp("^" + O + "(" + Z + ")")]);
	    }var ae = af["types"];if (ae) {
	      ab.push([R, ae]);
	    }var ac = ("" + af["keywords"]).replace(/^ | $/g, "");if (ac.length) {
	      ab.push([B, new RegExp("^(?:" + ac.replace(/[\s,]+/g, "|") + ")\\b"), null]);
	    }X.push([H, /^\s+/, null, " \r\n\t\xA0"]);var V = "^.[^\\s\\w.$@'\"`/\\\\]*";if (af["regexLiterals"]) {
	      V += "(?!s*/)";
	    }ab.push([I, /^@[a-z_$][a-z_$@0-9]*/i, null], [R, /^(?:[@_]?[A-Z]+[a-z][A-Za-z_$@0-9]*|\w+_t\b)/, null], [H, /^[a-z_$][a-z_$@0-9]*/i, null], [I, new RegExp("^(?:" + "0x[a-f0-9]+" + "|(?:\\d(?:_\\d+)*\\d*(?:\\.\\d*)?|\\.\\d\\+)" + "(?:e[+\\-]?\\d+)?" + ")" + "[a-z]*", "i"), null, "0123456789"], [H, /^\\[\s\S]?/, null], [N, new RegExp(V), null]);return f(X, ab);
	  }var M = h({ "keywords": C, "hashComments": true, "cStyleComments": true, "multiLineStrings": true, "regexLiterals": true });function T(X, ai, ab) {
	    var W = /(?:^|\s)nocode(?:\s|$)/;var ad = /\r\n?|\n/;var ae = X.ownerDocument;var ah = ae.createElement("li");while (X.firstChild) {
	      ah.appendChild(X.firstChild);
	    }var Y = [ah];function ag(ao) {
	      var an = ao.nodeType;if (an == 1 && !W.test(ao.className)) {
	        if ("br" === ao.nodeName) {
	          af(ao);if (ao.parentNode) {
	        ...
	        if ((an == 3 || an == 4) && ab) {
	          var ap = ao.nodeValue;var al = ap.match(ad);if (al) {
	            var ak = ap.substring(0, al.index);ao.nodeValue = ak;var aj = ap.substring(al.index + al[0].length);if (aj) {
	              var am = ao.parentNode;am.insertBefore(ae.createTextNode(aj), ao.nextSibling);
	            }af(ao);if (!ak) {
	              ao.parentNode.removeChild(ao);
	            }
	          }
	      ...
	      while (!am.nextSibling) {
	        am = am.parentNode;if (!am) {
	          return;
	        }
	      }function ak(an, au) {
	        var at = au ? an.cloneNode(false) : an;var aq = an.parentNode;if (aq) {
	          var ar = ak(aq, 1);var ap = an.nextSibling;ar.appendChild(at);for (var ao = ap; ao; ao = ap) {
	            ap = ao.nextSibling;ar.appendChild(ao);
	          }
	        }return at;
	      }var aj = ak(am.nextSibling, 0);for (var al; (al = aj.parentNode) && al.nodeType === 1;) {
	        aj = al;
	      }Y.push(aj);
	    ...
	    }var ac = ae.createElement("ol");ac.className = "linenums";var Z = Math.max(0, ai - 1 | 0) || 0;for (var aa = 0, V = Y.length; aa < V; ++aa) {
	      ah = Y[aa];ah.className = "L" + (aa + Z) % 10;if (!ah.firstChild) {
	        ah.appendChild(ae.createTextNode("\xA0"));
	      }ac.appendChild(ah);
	    }X.appendChild(ac);
	  }function F(ag) {
	    var Y = /\bMSIE\s(\d+)/.exec(navigator.userAgent);Y = Y && +Y[1] <= 8;var ap = /\n/g;var ao = ag.sourceCode;var aq = ao.length;var Z = 0;var ae = ag.spans;var W = ae.length;var ak = 0;var ab = ag.decorations;var ac = ab.length;var ad = 0;ab[ac] = aq;var aw, au;for (au = aw = 0; au < ac;) {
	      if (ab[au] !== ab[au + 2]) {
	        ab[aw++] = ab[au++];ab[aw++] = ab[au++];
	      } else {
	        au += 2;
	      }
	    }ac = aw;for (au = aw = 0; au < ac;) {
	      var ax = ab[au];var af = ab[au + 1];var aa = au + 2;while (aa + 2 <= ac && ab[aa + 1] === af) {
	        aa += 2;
	      }ab[aw++] = ax;ab[aw++] = af;au = aa;
	    }ac = ab.length = aw;var av = ag.sourceNode;var al;if (av) {
	      al = av.style.display;av.style.display = "none";
	    }try {
	      var ai = null;while (ak < W) {
	        var aj = ae[ak];var V = ae[ak + 2] || aq;var at = ab[ad + 2] || aq;var aa = Math.min(V, at);var an = ae[ak + 1];var X;if (an.nodeType !== 1 && (X = ao.substring(Z, aa))) {
	          if (Y) {
	            X = X.replace(ap, "\r");
	          }an.nodeValue = X;var am = an.ownerDocument;var ar = am.createElement("span");ar.className = ab[ad + 1];var ah = an.parentNode;ah.replaceChild(ar, an);ar.appendChild(an);if (Z < V) {
	            ae[ak + 1] = an = am.createTextNode(ao.substring(aa, V));ah.insertBefore(an, ar.nextSibling);
	          }
	        }Z = aa;if (Z >= V) {
	          ak += 2;
	        }if (Z >= at) {
	  ...
	  }var t = {};function c(X, Y) {
	    for (var V = Y.length; --V >= 0;) {
	      var W = Y[V];if (!t.hasOwnProperty(W)) {
	        t[W] = X;
	      } else {
	        if (P["console"]) {
	    ...
	    var V = document.createElement("div");V.innerHTML = "<pre>" + Z + "</pre>";V = V.firstChild;if (X) {
	      T(V, X, true);
	    }var W = { langExtension: Y, numberLines: X, sourceNode: V, pre: 1 };d(W);return V.innerHTML;
	  }function w(al, ab) {
	    var ah = ab || document.body;var ao = ah.ownerDocument || document;function aa(aq) {
	      return ah.getElementsByTagName(aq);
	    }var ad = [aa("pre"), aa("code"), aa("xmp")];var ae = [];for (var ak = 0; ak < ad.length; ++ak) {
	      for (var aj = 0, ag = ad[ak].length; aj < ag; ++aj) {
	        ae.push(ad[ak][aj]);
	      }
	    }ad = null;var ap = Date;if (!ap["now"]) {
	      ap = { "now": function now() {
	          return +new Date();
	        } };
	    }var ai = 0;var ac;var X = /\blang(?:uage)?-([\w.]+)(?!\S)/;var an = /\bprettyprint\b/;var W = /\bprettyprinted\b/;var Z = /pre|xmp/i;var V = /^code$/i;var Y = /^(?:pre|code|xmp)$/i;var am = {};function af() {
	      var ay = P["PR_SHOULD_USE_CONTINUATION"] ? ap["now"]() + 250 : Infinity;for (; ai < ae.length && ap["now"]() < ay; ai++) {
	        var aA = ae[ai];var aH = am;for (var ax = aA; ax = ax.previousSibling;) {
	          var aE = ax.nodeType;var aF = (aE === 7 || aE === 8) && ax.nodeValue;if (aF ? !/^\??prettify\b/.test(aF) : aE !== 3 || /\S/.test(ax.nodeValue)) {
	            break;
	          }if (aF) {
	            aH = {};aF.replace(/\b(\w+)=([\w:.%+-]+)/g, function (aJ, aI, aK) {
	              aH[aI] = aK;
	            });break;
	          }
	        }var aB = aA.className;if ((aH !== am || an.test(aB)) && !W.test(aB)) {
	          var aD = false;for (var au = aA.parentNode; au; au = au.parentNode) {
	            var aG = au.tagName;if (Y.test(aG) && au.className && an.test(au.className)) {
	              aD = true;break;
	            }
	          }if (!aD) {
	            aA.className += " prettyprinted";var aw = aH["lang"];if (!aw) {
	              aw = aB.match(X);var ar;if (!aw && (ar = o(aA)) && V.test(ar.tagName)) {
	                aw = ar.className.match(X);
	              }if (aw) {
	                aw = aw[1];
	              }
	            }var av;if (Z.test(aA.tagName)) {
	              av = 1;
	            } else {
	              var at = aA["currentStyle"];var az = ao.defaultView;var aq = at ? at["whiteSpace"] : az && az.getComputedStyle ? az.getComputedStyle(aA, null).getPropertyValue("white-space") : 0;av = aq && "pre" === aq.substring(0, 3);
	            }var aC = aH["linenums"];if (!(aC = aC === "true" || +aC)) {
	              aC = aB.match(/\blinenums\b(?::(\d+))?/);aC = aC ? aC[1] && aC[1].length ? +aC[1] : true : false;
	            }if (aC) {
	              T(aA, aC, av);
	            }ac = { langExtension: aw, sourceNode: aA, numberLines: aC, pre: av };d(ac);
	          }
	        }
	      }if (ai < ae.length) {
	        setTimeout(af, 250);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  function n(n) {
	  ...
	  }; true ? ("undefined" != typeof module && module.exports && (exports = module.exports = m), exports._ = m) : e._ = m, m.VERSION = "1.8.2";var d = function d(n, t, r) {
	    ...
	    if (n === t) return 0 !== n || 1 / n === 1 / t;if (null == n || null == t) return n === t;n instanceof m && (n = n._wrapped), t instanceof m && (t = t._wrapped);var u = f.call(n);if (u !== f.call(t)) return !1;switch (u) {case "[object RegExp]":case "[object String]":
	      ...
	      if ("object" != (typeof n === "undefined" ? "undefined" : (0, _typeof3.default)(n)) || "object" != (typeof t === "undefined" ? "undefined" : (0, _typeof3.default)(t))) return !1;var o = n.constructor,
	    ...
	    var t = typeof n === "undefined" ? "undefined" : (0, _typeof3.default)(n);return "function" === t || "object" === t && !!n;
	  ...
	  }), "function" != typeof /./ && "object" != (typeof Int8Array === "undefined" ? "undefined" : (0, _typeof3.default)(Int8Array)) && (m.isFunction = function (n) {
	  ...
	  var e = "undefined" != typeof jQuery ? jQuery : Zepto;if ("undefined" != typeof e) {
	    var t = function t(e, i) {
	      return new t.fn.init(e, i);
	        ...
	        var i = this.settings;return i.editorTheme = e, "default" !== e && t.loadCSS(i.path + "codemirror/theme/" + i.editorTheme), this.cm.setOption("theme", e), this;
	        ...
	        var e = this.settings,
	            i = this.editor;"default" !== e.editorTheme && t.loadCSS(e.path + "codemirror/theme/" + e.editorTheme);var o = { mode: e.mode, theme: e.editorTheme, tabSize: e.tabSize, dragDrop: !1, autofocus: e.autoFocus, autoCloseTags: e.autoCloseTags, readOnly: e.readOnly ? "nocursor" : !1, indentUnit: e.indentUnit, lineNumbers: e.lineNumbers, lineWrapping: e.lineWrapping, extraKeys: { "Ctrl-Q": function CtrlQ(e) {
	              e.foldCode(e.getCursor());
	            } }, foldGutter: e.codeFold, gutters: ["CodeMirror-linenumbers", "CodeMirror-foldgutter"], matchBrackets: e.matchBrackets, indentWithTabs: e.indentWithTabs, styleActiveLine: e.styleActiveLine, styleSelectedText: e.styleSelectedText, autoCloseBrackets: e.autoCloseBrackets, showTrailingSpace: e.showTrailingSpace, highlightSelectionMatches: e.matchWordHighlight ? { showToken: "onselected" === e.matchWordHighlight ? !1 : /\w/ } : !1 };return this.codeEditor = this.cm = t.$CodeMirror.fromTextArea(this.markdownTextarea[0], o), this.codeMirror = this.cmElement = i.children(".CodeMirror"), "" !== e.value && this.cm.setValue(e.value), this.codeMirror.css({ fontSize: e.fontSize, width: e.watch ? "50%" : "100%" }), e.autoHeight && (this.codeMirror.css("height", "auto"), this.cm.setOption("viewportMargin", 1 / 0)), e.lineNumbers || this.codeMirror.find(".CodeMirror-gutters").css("border-right", "none"), this;
	        ...
	        var i = this.settings;if (!i.gotoLine) return this;var o = this.cm,
	            r = (this.editor, o.lineCount()),
	            n = this.preview;if (("string" == typeof t && ("last" === t && (t = r), "first" === t && (t = 1)), "number" != typeof t)) return alert("Error: The line number must be an integer."), this;if ((t = parseInt(t) - 1, t > r)) return alert("Error: The line number range 1-" + r), this;o.setCursor({ line: t, ch: 0 });var a = o.getScrollInfo(),
	            s = a.clientHeight,
	          ...
	          var c = this.codeMirror.find(".CodeMirror-scroll")[0],
	              h = e(c).height(),
	              d = c.scrollTop,
	              u = d / c.scrollHeight;n.scrollTop(0 === d ? 0 : d + h >= c.scrollHeight - 16 ? n[0].scrollHeight : n[0].scrollHeight * u);
	        }return o.focus(), this;
	        ...
	        var o = this.settings;return "object" == (typeof t === "undefined" ? "undefined" : (0, _typeof3.default)(t)) && (o = e.extend(!0, o, t)), "string" == typeof t && (o[t] = i), this.settings = o, this.recreate(), this;
	      }, on: function on(t, i) {
	        var o = this.settings;return "undefined" != typeof o["on" + t] && (o["on" + t] = e.proxy(i, this)), this;
	      }, off: function off(e) {
	        var t = this.settings;return "undefined" != typeof t["on" + e] && (t["on" + e] = function () {}), this;
	      }, showToolbar: function showToolbar(t) {
	        var i = this.settings;return i.readOnly ? this : (i.toolbar && (this.toolbar.length < 1 || "" === this.toolbar.find("." + this.classPrefix + "menu").html()) && this.setToolbar(), i.toolbar = !0, this.toolbar.show(), this.resize(), e.proxy(t || function () {}, this)(), this);
	      }, hideToolbar: function hideToolbar(t) {
	        var i = this.settings;return i.toolbar = !1, this.toolbar.hide(), this.resize(), e.proxy(t || function () {}, this)(), this;
	      }, setToolbarAutoFixed: function setToolbarAutoFixed(t) {
	        var i = this.state,
	            o = this.editor,
	            r = this.toolbar,
	            n = this.settings;"undefined" != typeof t && (n.toolbarAutoFixed = t);var a = function a() {
	          var t = e(window),
	        ...
	        var e = this.settings;if (e.readOnly) return this;var i = this.editor,
	            ...
	            r = this.toolbar = i.children("." + o + "toolbar");if (e.toolbar && r.length < 1) {
	          var n = '<div class="' + o + 'toolbar"><div class="' + o + 'toolbar-container"><ul class="' + o + 'menu"></ul></div></div>';i.append(n), r = this.toolbar = i.children("." + o + "toolbar");
	        }if (!e.toolbar) return r.hide(), this;r.show();for (var a = "function" == typeof e.toolbarIcons ? e.toolbarIcons() : "string" == typeof e.toolbarIcons ? t.toolbarModes[e.toolbarIcons] : e.toolbarIcons, s = r.find("." + this.classPrefix + "menu"), l = "", c = !1, h = 0, d = a.length; d > h; h++) {
	          var u = a[h];if ("||" === u) c = !0;else if ("|" === u) l += '<li class="divider" unselectable="on">|</li>';else {
	            var f = /h(\d)/.test(u),
	                g = u;"watch" !== u || e.watch || (g = "unwatch");var p = e.lang.toolbar[g],
	                m = e.toolbarIconTexts[g],
	                w = e.toolbarIconsClass[g];p = "undefined" == typeof p ? "" : p, m = "undefined" == typeof m ? "" : m, w = "undefined" == typeof w ? "" : w;var v = c ? '<li class="pull-right">' : "<li>";"undefined" != typeof e.toolbarCustomIcons[u] && "function" != typeof e.toolbarCustomIcons[u] ? v += e.toolbarCustomIcons[u] : (v += '<a href="javascript:;" title="' + p + '" unselectable="on">', v += '<i class="fa ' + w + '" name="' + u + '" unselectable="on">' + (f ? u.toUpperCase() : "" === w ? m : "") + "</i>", v += "</a>"), v += "</li>", l = c ? v + l : l + v;
	          }
	        ...
	        var i = this.toolbarHandlers = t.toolbarHandlers;return e && "undefined" != typeof toolbarIconHandlers[e] ? i[e] : i;
	        ...
	        var i = this,
	          ...
	          var r = e(this).children(".fa"),
	              a = r.attr("name"),
	              s = n.getCursor(),
	              c = n.getSelection();return "" !== a ? (i.activeIcon = r, "undefined" != typeof l[a] ? e.proxy(l[a], i)(n) : "undefined" != typeof o.toolbarHandlers[a] && e.proxy(o.toolbarHandlers[a], i)(n, r, s, c), "link" !== a && "reference-link" !== a && "image" !== a && "code-block" !== a && "preformatted-text" !== a && "watch" !== a && "preview" !== a && "search" !== a && "fullscreen" !== a && "info" !== a && n.focus(), !1) : void 0;
	        }), this;
	        ...
	        e("html,body").css("overflow-x", "hidden");var i = this.editor,
	            o = this.settings,
	        ...
	        var e = this.settings,
	            t = this.previewContainer;return e.previewCodeHighlight && (t.find("pre").addClass("prettyprint linenums"), "undefined" != typeof prettyPrint && prettyPrint()), this;
	      }, katexRender: function katexRender() {
	        return null === i ? this : (this.previewContainer.find("." + t.classNames.tex).each(function () {
	          var i = e(this);t.$katex.render(i.text(), i[0]), i.find(".katex").css("font-size", "1.6em");
	        }), this);
	      }, flowChartAndSequenceDiagramRender: function flowChartAndSequenceDiagramRender() {
	        var i = this,
	            r = this.settings,
	            n = this.previewContainer;if (t.isIE8) return this;if (r.flowChart) {
	          if (null === o) return this;n.find(".flowchart").flowChart();
	            ...
	            u = 0;a.find(".markdown-toc-list").each(function () {
	          u += e(this).height();
	        });var f = a.find(".editormd-toc-menu").height();return f = f ? f : 0, a.scrollTop(0 === h ? 0 : h + c >= l[0].scrollHeight - 16 ? a[0].scrollHeight : (a[0].scrollHeight + u + f) * d), this;
	      }, registerKeyMaps: function registerKeyMaps(i) {
	        var o = this,
	            r = this.cm,
	            n = this.settings,
	            a = t.toolbarHandlers,
	            s = n.disabledKeyMaps;if (i = i || null) {
	          for (var l in i) {
	            if (e.inArray(l, s) < 0) {
	              var c = {};c[l] = i[l], r.addKeyMap(i);
	            }
	          }
	        } else {
	          for (var h in t.keyMaps) {
	            var d = t.keyMaps[h],
	                u = "string" == typeof d ? e.proxy(a[d], o) : e.proxy(d, o);if (e.inArray(h, ["F9", "F10", "F11"]) < 0 && e.inArray(h, s) < 0) {
	              var f = {};f[h] = u, r.addKeyMap(f);
	            }
	          }e(window).keydown(function (t) {
	            var i = { 120: "F9", 121: "F10", 122: "F11" };if (e.inArray(i[t.keyCode], s) < 0) switch (t.keyCode) {case 120:
	                return e.proxy(a.watch, o)(), !1;case 121:
	                return e.proxy(a.preview, o)(), !1;case 122:
	        ...
	        var i = this,
	            ...
	            r = this.settings,
	            n = this.codeMirror,
	            a = t.mouseOrTouch;if (!r.syncScrolling) return this;var s = function s() {
	          n.find(".CodeMirror-scroll").bind(a("scroll", "touchmove"), function (t) {
	            var n = e(this).height(),
	                a = e(this).scrollTop(),
	                s = a / e(this)[0].scrollHeight,
	                l = 0;o.find(".markdown-toc-list").each(function () {
	              l += e(this).height();
	            });var c = o.find(".editormd-toc-menu").height();c = c ? c : 0, o.scrollTop(0 === a ? 0 : a + n >= e(this)[0].scrollHeight - 16 ? o[0].scrollHeight : (o[0].scrollHeight + l + c) * s), e.proxy(r.onscroll, i)(t);
	          });
	        },
	            l = function l() {
	          ...
	          o.bind(a("scroll", "touchmove"), function (t) {
	            var o = e(this).height(),
	                a = e(this).scrollTop(),
	                s = a / e(this)[0].scrollHeight,
	                l = n.find(".CodeMirror-scroll");l.scrollTop(0 === a ? 0 : a + o >= e(this)[0].scrollHeight ? l[0].scrollHeight : l[0].scrollHeight * s), e.proxy(r.onpreviewscroll, i)(t);
	          });
	        },
	            h = function h() {
	        ...
	        var e = this,
	            t = this.cm,
	            o = this.settings;return o.syncScrolling ? (t.on("change", function (t, r) {
	        ...
	        t = t || !1;var i = this,
	            o = this.editor,
	            r = this.preview,
	            n = this.settings;return this.containerMask.hide(), this.save(), n.watch && r.show(), o.data("oldWidth", o.width()).data("oldHeight", o.height()), this.resize(), this.registerKeyMaps(), e(window).resize(function () {
	          i.resize();
	        ...
	        t = t || null, i = i || null;var o = this.state,
	            r = this.editor,
	            n = this.preview,
	            a = this.toolbar,
	            s = this.settings,
	          ...
	          if ((l.width(r.width() / 2), n.width(o.preview ? r.width() : r.width() / 2), this.previewContainer.css("padding", s.autoHeight ? "20px 20px 50px 40px" : "20px"), s.toolbar && !s.readOnly ? n.css("top", a.height() + 1) : n.css("top", 0), !s.autoHeight || o.fullscreen || o.preview)) {
	            var c = s.toolbar && !s.readOnly ? r.height() - a.height() : r.height();n.height(c);
	          } else n.height("");
	        } else l.width(r.width()), n.hide();return o.loaded && e.proxy(s.onresize, this)(), this;
	      }, save: function save() {
	        if (null === i) return this;var r = this,
	            n = this.state,
	            a = this.settings,
	            s = this.cm,
	            l = s.getValue(),
	            ...
	            f = this.markedOptions = { renderer: t.markedRenderer(d, u), gfm: !0, tables: !0, breaks: !0, pedantic: !1, sanitize: a.htmlDecode ? !1 : !0, smartLists: !0, smartypants: !0 };h.setOptions(f);var g = t.$marked(l, f);if ((g = t.filterHTMLTags(g, a.htmlDecode), this.markdownTextarea.text(l), s.save(), a.saveHTMLToTextarea && this.htmlTextarea.text(g), a.watch || !a.watch && n.preview)) {
	        ...
	        var t = (this.settings, this.cm);return t.setValue(t.getValue() + e), this;
	        ...
	        var o = this.settings;if (e.inArray(o.mode, ["gfm", "markdown"]) < 0) return this;if ((this.state.watching = o.watch = !0, this.preview.show(), this.toolbar)) {
	        ...
	        var i = this.settings;if ((this.state.watching = i.watch = !1, this.preview.hide(), this.toolbar)) {
	        ...
	        t = t || function () {};var i = this;return this.editor.show(0, function () {
	          e.proxy(t, i)();
	        }), this;
	      }, hide: function hide(t) {
	        t = t || function () {};var i = this;return this.editor.hide(0, function () {
	          e.proxy(t, i)();
	        }), this;
	        ...
	        var i = this,
	            ...
	            a = this.settings,
	            s = this.codeMirror,
	            l = this.previewContainer;if (e.inArray(a.mode, ["gfm", "markdown"]) < 0) return this;a.toolbar && n && (n.toggle(), n.find(".fa[name=preview]").toggleClass("active")), s.toggle();var c = function c(e) {
	          ...
	          i.previewed();
	        }), a.watch ? l.css("padding", "") : this.save(), l.addClass(this.classPrefix + "preview-active"), r.show().css({ position: "", top: 0, width: o.width(), height: a.autoHeight && !this.state.fullscreen ? "auto" : o.height() }), this.state.loaded && e.proxy(a.onpreviewing, this)(), e(window).bind("keyup", c)) : (e(window).unbind("keyup", c), this.previewed());
	        ...
	        var t = this,
	            ...
	            n = this.settings,
	            a = this.classPrefix + "fullscreen";r && r.find(".fa[name=fullscreen]").parent().toggleClass("active");var s = function s(e) {
	        ...
	        var r = this,
	            n = this.cm,
	            a = this.settings;return o = a.pluginPath + o,  true ? "undefined" == typeof this[i] ? (alert("Error: " + i + " plugin is not found, you are not load this plugin."), this) : (this[i](n), this) : (e.inArray(o, t.loadFiles.plugin) < 0 ? t.loadPlugin(o, function () {
	          t.loadPlugins[i] = r[i], r[i](n);
	        }) : e.proxy(t.loadPlugins[i], this)(n), this);
	      }, search: function search(e) {
	        var t = this.settings;return t.searchReplace ? (t.readOnly || this.cm.execCommand(e || "find"), this) : (alert("Error: settings.searchReplace == false"), this);
	      ...
	      var t = this.settings || { dialogLockScreen: !0 };t.dialogLockScreen && (e("html,body").css("overflow", "hidden"), this.resize());
	      ...
	      var i = this.editor,
	    ...
	    }, t.toolbarHandlers = { undo: function undo() {
	        this.cm.undo();
	      }, redo: function redo() {
	        this.cm.redo();
	      }, bold: function bold() {
	        ...
	        var e = this.cm,
	            t = e.getCursor(),
	            i = e.getSelection();0 !== t.ch ? (e.setCursor(t.line, 0), e.replaceSelection("> " + i), e.setCursor(t.line, t.ch + 2)) : e.replaceSelection("> " + i);
	        ...
	        var e = this.cm,
	            t = e.getCursor(),
	            i = e.getSelection();0 !== t.ch ? (e.setCursor(t.line, 0), e.replaceSelection("## " + i), e.setCursor(t.line, t.ch + 3)) : e.replaceSelection("## " + i);
	      }, h3: function h3() {
	        var e = this.cm,
	            t = e.getCursor(),
	            i = e.getSelection();0 !== t.ch ? (e.setCursor(t.line, 0), e.replaceSelection("### " + i), e.setCursor(t.line, t.ch + 4)) : e.replaceSelection("### " + i);
	      }, h4: function h4() {
	        var e = this.cm,
	            t = e.getCursor(),
	            i = e.getSelection();0 !== t.ch ? (e.setCursor(t.line, 0), e.replaceSelection("#### " + i), e.setCursor(t.line, t.ch + 5)) : e.replaceSelection("#### " + i);
	      }, h5: function h5() {
	        var e = this.cm,
	            t = e.getCursor(),
	            i = e.getSelection();0 !== t.ch ? (e.setCursor(t.line, 0), e.replaceSelection("##### " + i), e.setCursor(t.line, t.ch + 6)) : e.replaceSelection("##### " + i);
	      }, h6: function h6() {
	        var e = this.cm,
	            t = e.getCursor(),
	            i = e.getSelection();0 !== t.ch ? (e.setCursor(t.line, 0), e.replaceSelection("###### " + i), e.setCursor(t.line, t.ch + 7)) : e.replaceSelection("###### " + i);
	      }, "list-ul": function listUl() {
	        var e = this.cm,
	            t = (e.getCursor(), e.getSelection());if ("" === t) e.replaceSelection("- " + t);else {
	        ...
	        var e = this.cm,
	            t = (e.getCursor(), e.getSelection());if ("" === t) e.replaceSelection("1. " + t);else {
	          for (var i = t.split("\n"), o = 0, r = i.length; r > o; o++) {
	            i[o] = "" === i[o] ? "" : o + 1 + ". " + i[o];
	          }e.replaceSelection(i.join("\n"));
	        }
	        ...
	        if (!this.settings.tex) return alert("settings.tex === false"), this;var e = this.cm,
	            t = e.getCursor(),
	            i = e.getSelection();e.replaceSelection("$$" + i + "$$"), "" === i && e.setCursor(t.line, t.ch + 2);
	      }, link: function link() {
	        ...
	        var e = this.cm,
	            ...
	            o = t.dateFormat() + " " + t.dateFormat("zh-cn" === i || "zh-tw" === i ? "cn-week-day" : "week-day");e.replaceSelection(o);
	        ...
	        this.showInfoDialog();
	      } }, t.keyMaps = { "Ctrl-1": "h1", "Ctrl-2": "h2", "Ctrl-3": "h3", "Ctrl-4": "h4", "Ctrl-5": "h5", "Ctrl-6": "h6", "Ctrl-B": "bold", "Ctrl-D": "datetime", "Ctrl-E": function CtrlE() {
	        var e = this.cm,
	            t = e.getCursor(),
	      ...
	      }, "Ctrl-Alt-G": "goto-line", "Ctrl-H": "hr", "Ctrl-I": "italic", "Ctrl-K": "code", "Ctrl-L": function CtrlL() {
	        var e = this.cm,
	            t = e.getCursor(),
	            i = e.getSelection(),
	            o = "" === i ? "" : ' "' + i + '"';e.replaceSelection("[" + i + "](" + o + ")"), "" === i && e.setCursor(t.line, t.ch + 1);
	      }, "Ctrl-U": "list-ul", "Shift-Ctrl-A": function ShiftCtrlA() {
	        var e = this.cm,
	            t = e.getCursor(),
	      ...
	      }, "Shift-Ctrl-C": "code", "Shift-Ctrl-Q": "quote", "Shift-Ctrl-S": "del", "Shift-Ctrl-K": "tex", "Shift-Alt-C": function ShiftAltC() {
	        var e = this.cm,
	            t = e.getCursor(),
	            i = e.getSelection();e.replaceSelection(["```", i, "```"].join("\n")), "" === i && e.setCursor(t.line, t.ch + 3);
	      }, "Shift-Ctrl-Alt-C": "code-block", "Shift-Ctrl-H": "html-entities", "Shift-Alt-H": "help", "Shift-Ctrl-E": "emoji", "Shift-Ctrl-U": "uppercase", "Shift-Alt-U": "ucwords", "Shift-Ctrl-Alt-U": "ucfirst", "Shift-Alt-L": "lowercase", "Shift-Ctrl-I": function ShiftCtrlI() {
	        var e = this.cm,
	            t = e.getCursor(),
	            i = e.getSelection(),
	            o = "" === i ? "" : ' "' + i + '"';e.replaceSelection("![" + i + "](" + o + ")"), "" === i && e.setCursor(t.line, t.ch + 4);
	      }, "Shift-Ctrl-Alt-I": "image", "Shift-Ctrl-L": "link", "Shift-Ctrl-O": "list-ol", "Shift-Ctrl-P": "preformatted-text", "Shift-Ctrl-T": "table", "Shift-Alt-P": "pagebreak", F9: "watch", F10: "preview", F11: "fullscreen" };var r = function r(e) {
	      return String.prototype.trim ? e.trim() : e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
	    };t.trim = r;var n = function n(e) {
	      return e.toLowerCase().replace(/\b(\w)|\s(\w)/g, function (e) {
	        return e.toUpperCase();
	      });
	    };t.ucwords = t.wordsFirstUpperCase = n;var a = function a(e) {
	      ...
	      var n = { toc: !0, tocm: !1, tocStartLevel: 1, pageBreak: !0, atLink: !0, emailLink: !0, taskList: !1, emoji: !1, tex: !1, flowChart: !1, sequenceDiagram: !1 },
	          a = e.extend(n, o || {}),
	          s = t.$marked,
	          l = new s.Renderer();i = i || [];var c = t.regexs,
	          h = c.atLink,
	          d = c.emoji,
	          u = c.email,
	          f = c.emailLink,
	        ...
	        e = e.replace(t.regexs.emojiDatetime, function (e) {
	          return e.replace(/:/g, "&#58;");
	        });var i = e.match(d);if (!i || !a.emoji) return e;for (var o = 0, r = i.length; r > o; o++) {
	          ":+1:" === i[o] && (i[o] = ":\\+1:"), e = e.replace(new RegExp(i[o]), function (e, i) {
	            var o = e.match(p),
	                r = e.replace(/:/g, "");if (o) for (var n = 0, a = o.length; a > n; n++) {
	              var s = o[n].replace(/:/g, "");return '<i class="fa ' + s + ' fa-emoji" title="' + s.replace("fa-", "") + '"></i>';
	            } else {
	              var l = e.match(m),
	                  c = e.match(g);if (l) for (var h = 0, d = l.length; d > h; h++) {
	                var u = l[h].replace(/:/g, "");return '<i class="' + u + '" title="Editor.md logo (' + u + ')"></i>';
	              } else {
	                if (!c) {
	                  var f = "+1" === r ? "plus1" : r;return f = "black_large_square" === f ? "black_square" : f, f = "moon" === f ? "waxing_gibbous_moon" : f, '<img src="' + t.emoji.path + f + t.emoji.ext + '" class="emoji" title="&#58;' + r + '&#58;" alt="&#58;' + r + '&#58;" />';
	                }for (var w = 0, v = c.length; v > w; w++) {
	                  var k = c[w].replace(/:/g, "").replace("tw-", "");return '<img src="' + t.twemoji.path + k + t.twemoji.ext + '" title="twemoji-' + k + '" alt="twemoji-' + k + '" class="emoji twemoji" />';
	                }
	              }
	            }
	          });
	        ...
	        }var n = '<a href="' + e + '"';return h.test(t) || h.test(i) ? (t && (n += ' title="' + t.replace(/@/g, "&#64;")), n + '">' + i.replace(/@/g, "&#64;") + "</a>") : (t && (n += ' title="' + t + '"'), n += ">" + i + "</a>");
	      }, l.heading = function (e, t, o) {
	        var n = e,
	            a = /\s*\<a\s*href\=\"(.*)\"\s*([^\>]*)\>(.*)\<\/a\>\s*/;if (a.test(e)) {
	          var s = [];e = e.split(/\<a\s*([^\>]+)\>([^\>]*)\<\/a\>/);for (var l = 0, c = e.length; c > l; l++) {
	            s.push(e[l].replace(/\s*href\=\"(.*)\"\s*/g, ""));
	          }e = s.join(" ");
	        }e = r(e);var h = e.toLowerCase().replace(/[^\w]+/g, "-"),
	            d = { text: e, level: t, slug: h },
	            u = /^[\u4e00-\u9fa5]+$/.test(e),
	            f = u ? escape(e).replace(/\%/g, "") : e.toLowerCase().replace(/[^\w]+/g, "-");i.push(d);var g = "<h" + t + ' id="h' + t + "-" + this.options.headerPrefix + f + '">';return g += '<a name="' + e + '" class="reference-link"></a>', g += '<span class="header-link octicon octicon-link"></span>', g += this.atLink(a ? this.emoji(n) : this.emoji(e)), g += "</h" + t + ">";
	        ...
	        var i = /\$\$(.*)\$\$/g.test(e),
	            ...
	            s = /^\[TOCM\]$/.test(e);e = !o && i ? e.replace(/(\$\$([^\$]*)\$\$)+/g, function (e, i) {
	          return '<span class="' + t.classNames.tex + '">' + i.replace(/\$/g, "") + "</span>";
	        }) : o ? e.replace(/\$/g, "") : e;var l = '<div class="markdown-toc editormd-markdown-toc">' + e + "</div>";return n ? s ? '<div class="editormd-toc-menu">' + l + "</div><br/>" : l : w.test(e) ? this.pageBreak(e) : "<p" + r + ">" + this.atLink(this.emoji(e)) + "</p>\n";
	      ...
	      var r = "",
	          n = 0,
	          a = this.classPrefix;o = o || 1;for (var s = 0, l = e.length; l > s; s++) {
	        var c = e[s].text,
	            h = e[s].level;o > h || (r += h > n ? "" : n > h ? new Array(n - h + 2).join("</ul></li>") : "</ul></li>", r += '<li><a class="toc-level-' + h + '" href="#' + c + '" level="' + h + '">' + c + "</a><ul>", n = h);
	      }var d = t.find(".markdown-toc");if (d.length < 1 && "false" === t.attr("previewContainer")) {
	        var u = '<div class="markdown-toc ' + a + 'markdown-toc"></div>';u = i ? '<div class="' + a + 'toc-menu">' + u + "</div>" : u, t.html(u), d = t.find(".markdown-toc");
	      ...
	      i = i || "Table of Contents";var o = 400,
	        ...
	        var t = e(this),
	          ...
	          s.show(), l.each(function () {
	            var t = e(this),
	                i = t.children("ul");if (("" === i.html() && i.remove(), i.length > 0 && "" !== i.html())) {
	              var r = t.children("a").first();r.children(".fa").length < 1 && r.append(e(n).css({ "float": "right", paddingTop: "4px" }));
	      ...
	      if (("string" != typeof t && (t = new String(t)), "string" != typeof i)) return t;for (var o = i.split("|"), r = o[0].split(","), n = o[1], a = 0, s = r.length; s > a; a++) {
	        var l = r[a];t = t.replace(new RegExp("<s*" + l + "s*([^>]*)>([^>]*)<s*/" + l + "s*>", "igm"), "");
	      }if ("undefined" != typeof n) {
	        var c = /\<(\w+)\s*([^\>]*)\>([^\>]*)\<\/(\w+)\>/gi;t = "*" === n ? t.replace(c, function (e, t, i, o, r) {
	          return "<" + t + ">" + o + "</" + r + ">";
	        }) : "on*" === n ? t.replace(c, function (t, i, o, r, n) {
	          var a = e("<" + i + ">" + r + "</" + n + ">"),
	              s = e(t)[0].attributes,
	              l = {};e.each(s, function (e, t) {
	            '"' !== t.nodeName && (l[t.nodeName] = t.nodeValue);
	          }), e.each(l, function (e) {
	            0 === e.indexOf("on") && delete l[e];
	          }), a.attr(l);var c = "undefined" != typeof a[1] ? e(a[1]).text() : "";return a[0].outerHTML + c;
	        }) : t.replace(c, function (t, i, o, r) {
	          var a = n.split(","),
	              s = e(t);return s.html(r), e.each(a, function (e) {
	            s.attr(a[e], null);
	          }), s[0].outerHTML;
	        });
	      }return t;
	    }, t.markdownToHTML = function (i, o) {
	      var r = { gfm: !0, toc: !0, tocm: !1, tocStartLevel: 1, tocTitle: "目录", tocDropdown: !1, tocContainer: "", markdown: "", markdownSourceCode: !1, htmlDecode: !1, autoLoadKaTeX: !0, pageBreak: !0, atLink: !0, emailLink: !0, tex: !1, taskList: !1, emoji: !1, flowChart: !1, sequenceDiagram: !1, previewCodeHighlight: !0 };t.$marked = marked;var n = e("#" + i),
	          a = n.settings = e.extend(!0, r, o || {}),
	          s = n.find("textarea");s.length < 1 && (n.append("<textarea></textarea>"), s = n.find("textarea"));var l = "" === a.markdown ? s.val() : a.markdown,
	          c = [],
	      ...
	      o = o || "head", i = i || function () {};var r = document.createElement("link");r.type = "text/css", r.rel = "stylesheet", r.onload = r.onreadystatechange = function () {
	      ...
	      o = o || "head", i = i || function () {};var r = null;r = document.createElement("script"), r.id = e.replace(/[\./]+/g, "-"), r.type = "text/javascript", r.src = e + ".js", t.isIE8 ? r.onreadystatechange = function () {
	    ...
	    }, t.katexURL = { css: "//cdnjs.cloudflare.com/ajax/libs/KaTeX/0.3.0/katex.min", js: "//cdnjs.cloudflare.com/ajax/libs/KaTeX/0.3.0/katex.min" }, t.kaTeXLoaded = !1, t.loadKaTeX = function (e) {
	      ...
	      var o = { name: "", width: 420, height: 240, title: "", drag: !0, closed: !0, content: "", mask: !0, maskStyle: { backgroundColor: "#fff", opacity: .1 }, lockScreen: !0, footer: !0, buttons: !1 };i = e.extend(!0, o, i);var r = this,
	          n = this.editor,
	          a = t.classPrefix,
	          s = new Date().getTime(),
	          l = "" === i.name ? a + "dialog-" + s : i.name,
	          c = t.mouseOrTouch,
	          h = '<div class="' + a + "dialog " + l + '">';"" !== i.title && (h += '<div class="' + a + 'dialog-header"' + (i.drag ? ' style="cursor: move;"' : "") + ">", h += '<strong class="' + a + 'dialog-title">' + i.title + "</strong>", h += "</div>"), i.closed && (h += '<a href="javascript:;" class="fa fa-close ' + a + 'dialog-close"></a>'), h += '<div class="' + a + 'dialog-container">' + i.content, (i.footer || "string" == typeof i.footer) && (h += '<div class="' + a + 'dialog-footer">' + ("boolean" == typeof i.footer ? "" : i.footer) + "</div>"), h += "</div>", h += '<div class="' + a + "dialog-mask " + a + 'dialog-mask-bg"></div>', h += '<div class="' + a + "dialog-mask " + a + 'dialog-mask-con"></div>', h += "</div>", n.append(h);var d = n.find("." + l);d.lockScreen = function (t) {
	        ...
	        var t = d.find("." + a + "dialog-mask");return t[e ? "show" : "hide"](), d;
	      }, d.lockScreen(!0).showMask(), d.show().css({ zIndex: t.dialogZindex, border: t.isIE8 ? "1px solid #ddd" : "", width: "number" == typeof i.width ? i.width + "px" : i.width, height: "number" == typeof i.height ? i.height + "px" : i.height });var u = function u() {
	        d.css({ top: (e(window).height() - d.height()) / 2 + "px", left: (e(window).width() - d.width()) / 2 + "px" });
	        ...
	        var f = d.footer = d.find("." + a + "dialog-footer");for (var g in i.buttons) {
	          var p = i.buttons[g],
	        ...
	        var w,
	            v,
	            k = d.children("." + a + "dialog-header");i.mask || k.bind(c("click", "touchend"), function () {
	          ...
	          e.addClass(a + "user-unselect").on("selectstart", function (e) {
	            ...
	            y = function y(t) {
	          t = t || window.event;var i,
	              o,
	              r = parseInt(d[0].style.left),
	              n = parseInt(d[0].style.top);r >= 0 ? r + d.width() <= e(window).width() ? i = t.clientX - w : (i = e(window).width() - d.width(), document.onmousemove = null) : (i = 0, document.onmousemove = null), n >= 0 ? o = t.clientY - v : (o = 0, document.onmousemove = null), document.onselectstart = function () {
	            return !1;
	          ...
	          var t = null,
	            ...
	            var o = _i.originalEvent,
	              ...
	              o = function o(i) {
	            i.preventDefault();var o = i.originalEvent;e(this).parent().css({ top: o.changedTouches[0].pageY - t.y, left: o.changedTouches[0].pageX - t.x });
	          };this.bind("touchstart", i).bind("touchmove", o);
	        }, k.touchDraggable();
	      }return t.dialogZindex += 2, d;
	    }, t.mouseOrTouch = function (e, t) {
	      e = e || "click", t = t || "touchend";var i = e;try {
	        document.createEvent("TouchEvent"), i = t;
	      } catch (o) {}return i;
	    }, t.dateFormat = function (e) {
	      e = e || "";var t = function t(e) {
	        return 10 > e ? "0" + e : e;
	      },
	          i = new Date(),
	          o = i.getFullYear(),
	          ...
	          f = r + "-" + n + "-" + a,
	          g = o + "-" + n + "-" + a,
	          p = l + ":" + c + ":" + h;switch (e) {case "UNIX Time":
	          u = i.getTime();break;case "UTC":
	          u = i.toUTCString();break;case "yy":
	          u = r;break;case "year":case "yyyy":
	          u = o;break;case "month":case "mm":
	          u = n;break;case "cn-week-day":case "cn-wd":
	          var m = ["日", "一", "二", "三", "四", "五", "六"];u = "星期" + m[s];break;case "week-day":case "wd":
	          var w = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];u = w[s];break;case "day":case "dd":
	          u = a;break;case "hour":case "hh":
	          u = l;break;case "min":case "ii":
	          u = c;break;case "second":case "ss":
	          u = h;break;case "ms":
	          u = d;break;case "yy-mm-dd":
	          u = f;break;case "yyyy-mm-dd":
	          u = g;break;case "yyyy-mm-dd h:i:s ms":case "full + ms":
	          u = g + " " + p + " " + d;break;case "full":case "yyyy-mm-dd h:i:s":default:
	          u = g + " " + p;}return u;
	    }, t;
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	hotAPI.install(require("vue"))
	if (!hotAPI.compatible) return
	var id = "-!babel-loader?presets[]=es2015&plugins[]=transform-runtime!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./router.vue"
	hotAPI.createRecord(id, module.exports)
	module.hot.accept(["-!babel-loader?presets[]=es2015&plugins[]=transform-runtime!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./router.vue","-!vue-html-loader!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./router.vue"], function () {
	var newOptions = require("-!babel-loader?presets[]=es2015&plugins[]=transform-runtime!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./router.vue")
	if (newOptions && newOptions.__esModule) newOptions = newOptions.default
	var newTemplate = require("-!vue-html-loader!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./router.vue")
	hotAPI.update(id, newOptions, newTemplate)
	})
	})()
	}
...
/***/ function(module, exports) {
	...
	//                     <div class="col-sm-6 col-md-4 col-lg-3" v-for="item in list">
	...
	//                                     <img class="" width="300" height="150" :src="item.imgsrc" >
	...
	//                                         <a href="{{item.link}}" title="{{item.title}}" target="_blank">{{item.content}}<br>
	...
	//                             <div class="thumbnail"><!--shake shake-slow-->
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = "<div class=\"wh-100\">\r\n    <section id=\"content\">\r\n        <section id=\"victor\">\r\n            <div id=\"output\"></div>\r\n            <section class=\"container text-center\">\r\n                <img src=\"" + __webpack_require__(69) + "\" class=\"finger bounceInDown ani-delay-2\"/>\r\n                <div class=\"myname zoomInDown ani-delay-10\">Michael Gong</div>\r\n                <p class=\"mydesc fadeInDown ani-delay-20\">热爱前端，喜欢css，乐于钻研，<br>对新兴事物比较感兴趣，喜欢捣鼓HTML5新技术</p>\r\n            </section>\r\n        </section>\r\n        <section class=\"container projects\">\r\n            <div class=\"projects-header page-header\">\r\n                <h2>Html5知识总结</h2>\r\n                <p>这些都是对html5中比较有意思的知识点的总结</p>\r\n            </div>\r\n            <div class=\"row\">\r\n                <section id=\"proList\" >\r\n                    <div class=\"col-sm-6 col-md-4 col-lg-3\" v-for=\"item in list\">\r\n                        <div v-if=\"item.link.indexOf('http')>=0\" >\r\n                            <div class=\"thumbnail\" >\r\n                                <a href=\"{{item.link}}\" title=\"{{item.title}}\" target=\"_blank\">\r\n                                    <img class=\"\" width=\"300\" height=\"150\" :src=\"item.imgsrc\" >\r\n                                </a>\r\n                                <div class=\"caption\">\r\n                                    <h3>\r\n                                        <a href=\"{{item.link}}\" title=\"{{item.title}}\" target=\"_blank\">{{item.content}}<br>\r\n                                            <small>{{item.desc}}</small>\r\n                                        </a>\r\n                                    </h3>\r\n                                    <p>{{item.detail}}</p>\r\n                                </div>\r\n                            </div>\r\n                        </div>\r\n                        <div v-else >\r\n                            <div class=\"thumbnail\"><!--shake shake-slow-->\r\n                                <a v-link=\"{name:'article',params:{name:item.link}}\" title=\"{{item.title}}\" >\r\n                                    <img class=\"\" width=\"300\" height=\"150\" :src=\"item.imgsrc\" >\r\n                                </a>\r\n\r\n                                <div class=\"caption\">\r\n                                    <h3>\r\n                                        <a title=\"{{item.title}}\" >{{item.content}}<br>\r\n                                            <small>{{item.desc}}</small>\r\n                                        </a>\r\n                                    </h3>\r\n                                    <p>{{item.detail}}</p>\r\n                                </div>\r\n                            </div>\r\n                        </div>\r\n\r\n                    </div>\r\n                </section>\r\n            </div>\r\n        </section>\r\n    </section>\r\n    <router-view transition=\"bounce\" transition-mode=\"in-out\"></router-view>\r\n</div>";

/***/ },
/* 69 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "images/5c7d71ffe169398ba3c00ea89200609e.png";
